...
const cancelOrderScreen = ({navigation}) => {
  return (
    <View style={styles.mainContainer}>
      ...
      <Text style={styles.text}>Reason of Cancellation of Order</Text>
        <View
          style={{
            flexDirection: 'row',
            marginTop: 10
          ...
          <BouncyCheckbox
            ...
            // }}
          />
          <Text style={styles.text2}>Changed my mind</Text>
        </View>
        <View
          style={{
            flexDirection: 'row',
          ...
          <BouncyCheckbox
            ...
            // }}
          />
          <Text style={styles.text2}>Wrong Shipping order</Text>
        </View>
        <View
          style={{
            flexDirection: 'row',
          ...
          <BouncyCheckbox
            ...
            // }}
          />
          <Text style={styles.text2}>Duplicate order</Text>
        </View>
        <View
          style={{
            flexDirection: 'row',
